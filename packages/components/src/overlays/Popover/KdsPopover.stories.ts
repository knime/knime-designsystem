...
export const Default: Story = {
  ...
  render: (args) => ({
    components: { KdsButton, KdsPopover },
    setup() {
...
export const SeparateAnchorEl: Story = {
  args: {
    placement: "bottom-right",
    showArrow: false,
    default: "This popover is anchored to a separate element.",
  },
  render: (args) => ({
    components: { KdsButton, KdsPopover },
    setup() {
...
export const DesignComparator: Story = {
  ...
  }) as unknown as Omit<Story, "parameters">),
};
...
export const TextOverflow: Story = {
  ...(buildTextOverflowStory({
    component: {
      ...
      template: `
        <KdsPopover v-model="open" :activator-el="null" placement="bottom-right" show-arrow>
