...
const meta: Meta<typeof KdsDateInput> = {
  ...
  args: {
    ...
    ariaLabel: undefined,
    description:
      "Seven columns wide, Hidden logic, styles all mine, Click to find the day.",
    ...
    error: false,
    subText:
      "Seconds tick away fast, Months and years in steady flow, Time waits for no one.",
...
export const NormalizesOnBlur: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Any valid date string (e.g. "March 11, 2026", "11/03/2026") is automatically ' +
          "normalized to the legacy yyyy-MM-dd format when the user leaves the field.",
      },
    },
  },
  args: {
...
export const Interaction: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step("Type a valid date into the input", async () => {
